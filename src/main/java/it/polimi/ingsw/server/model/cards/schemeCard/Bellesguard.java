...
public class Bellesguard extends GlassWindow {
    public Bellesguard(){
        super.setName("Bellesguard");
        super.setLink(4);
        super.setDifficulty(3);
        super.setSlot(0, Colour.BLUE, 0, 0);
        super.setSlot(6, Colour.WHITE, 0, 1);
        super.setSlot(0, Colour.WHITE, 0, 2);
        super.setSlot(0, Colour.WHITE, 0, 3);
        super.setSlot(0, Colour.YELLOW, 0, 4);
        super.setSlot(0, Colour.WHITE, 1, 0);
        super.setSlot(3, Colour.WHITE, 1, 1);
