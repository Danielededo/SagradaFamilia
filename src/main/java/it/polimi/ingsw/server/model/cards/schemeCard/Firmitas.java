...
public class Firmitas extends GlassWindow {
    public Firmitas(){
        super.setName("Firmitas");
        super.setLink(5);
        super.setDifficulty(5);
        super.setSlot(0, Colour.PURPLE, 0, 0);
        super.setSlot(6, Colour.WHITE, 0, 1);
        super.setSlot(0, Colour.WHITE, 0, 2);
        super.setSlot(0, Colour.WHITE, 0, 3);
        super.setSlot(3, Colour.WHITE, 0, 4);
        ...
        super.setSlot(2, Colour.WHITE, 2, 1);
        super.setSlot(0, Colour.PURPLE, 2, 2);
        super.setSlot(1, Colour.WHITE, 2, 3);
        super.setSlot(0, Colour.WHITE, 2, 4);
        super.setSlot(0, Colour.WHITE, 3, 0);
        super.setSlot(1, Colour.WHITE, 3, 1);
        super.setSlot(5, Colour.WHITE, 3, 2);
        super.setSlot(0, Colour.PURPLE, 3, 3);
