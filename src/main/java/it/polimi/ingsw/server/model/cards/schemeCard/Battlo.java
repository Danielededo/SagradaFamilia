...
public class Battlo extends GlassWindow {
    public Battlo(){
        super.setName("Battlo");
        super.setLink(4);
        super.setDifficulty(5);
        super.setSlot(0, Colour.WHITE, 0, 0);
        super.setSlot(0, Colour.WHITE, 0, 1);
        super.setSlot(6, Colour.WHITE, 0, 2);
