...
public class Firelight extends GlassWindow {
    public Firelight(){
        super.setName("Firelight");
        super.setLink(9);
        super.setDifficulty(5);
        super.setSlot(3, Colour.WHITE, 0, 0);
