...
public class ShadowThiefG extends Windows{
    ...
    public ShadowThiefG(){
        ...
        this.getCasella21().getChildren().addAll(new Faccia6(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella33().getChildren().addAll(new Faccia4(Constants.W_SLOT,Constants.H_SLOT));
