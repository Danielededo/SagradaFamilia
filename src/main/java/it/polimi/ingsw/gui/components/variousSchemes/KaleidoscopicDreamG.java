...
public class KaleidoscopicDreamG extends Windows{

    public KaleidoscopicDreamG(){

        super();
        this.setName("Kaleidoscopic Dream");
        ...
        this.getCasella10().setStyle("-fx-background-color: " + Constants.GREEN);
        ...
        this.getCasella33().setStyle("-fx-background-color: " + Constants.BLUE);
        this.getCasella34().setStyle("-fx-background-color: " + Constants.YELLOW);
        ...
        this.getCasella12().getChildren().addAll(new Faccia5(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella13().getChildren().addAll(new FacciaVuota(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella14().getChildren().addAll(new Faccia4(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella30().getChildren().addAll(new Faccia2(Constants.W_SLOT,Constants.H_SLOT));
