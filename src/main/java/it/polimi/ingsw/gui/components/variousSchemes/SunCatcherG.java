...
public class SunCatcherG extends Windows{

    public SunCatcherG(){

        super();
        this.setName("Sun Catcher");
        ...
        this.getCasella04().setStyle("-fx-background-color: " + Constants.YELLOW);
        ...
        this.getCasella13().setStyle("-fx-background-color: " + Constants.RED);
