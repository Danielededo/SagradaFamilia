...
public class VirtusG extends Windows{
    ...
    public VirtusG(){
        ...
        this.getCasella00().getChildren().addAll(new Faccia4(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella12().getChildren().addAll(new Faccia6(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella21().getChildren().addAll(new Faccia3(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella32().getChildren().addAll(new Faccia1(Constants.SLOT,Constants.SLOT));
