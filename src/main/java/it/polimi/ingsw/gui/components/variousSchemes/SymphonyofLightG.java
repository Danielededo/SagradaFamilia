...
public class SymphonyofLightG extends Windows{
    ...
    public SymphonyofLightG(){
        ...
        this.getCasella00().getChildren().addAll(new Faccia2(Constants.SLOT,Constants.SLOT));
        this.getCasella01().getChildren().addAll(new FacciaVuota(Constants.SLOT,Constants.SLOT));
        this.getCasella02().getChildren().addAll(new Faccia5(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella13().getChildren().addAll(new Faccia2(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella22().getChildren().addAll(new Faccia4(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella31().getChildren().addAll(new Faccia3(Constants.SLOT,Constants.SLOT));
        this.getCasella32().getChildren().addAll(new FacciaVuota(Constants.SLOT,Constants.SLOT));
        this.getCasella33().getChildren().addAll(new Faccia5(Constants.SLOT,Constants.SLOT));
