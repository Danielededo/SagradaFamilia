...
public class ChromaticSplendorG extends Windows{
    ...
    public ChromaticSplendorG(){
        ...
        this.getCasella10().getChildren().addAll(new Faccia2(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella14().getChildren().addAll(new Faccia1(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella30().getChildren().addAll(new Faccia1(Constants.SLOT,Constants.SLOT));
