...
public class ChromaticSplendorG extends Windows{

    public ChromaticSplendorG(){
        ...
        this.getCasella11().setStyle("-fx-background-color: " + Constants.YELLOW);
        ...
        this.getCasella10().getChildren().addAll(new Faccia2(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella14().getChildren().addAll(new Faccia1(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella32().getChildren().addAll(new Faccia6(Constants.W_SLOT,Constants.H_SLOT));
