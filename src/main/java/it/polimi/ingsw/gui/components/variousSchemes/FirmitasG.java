...
public class FirmitasG extends Windows{
    ...
    public FirmitasG(){
        ...
        this.getCasella01().getChildren().addAll(new Faccia6(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella04().getChildren().addAll(new Faccia3(Constants.SLOT,Constants.SLOT));
        this.getCasella10().getChildren().addAll(new Faccia5(Constants.SLOT,Constants.SLOT));
        this.getCasella11().getChildren().addAll(new FacciaVuota(Constants.SLOT,Constants.SLOT));
        this.getCasella12().getChildren().addAll(new Faccia3(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella21().getChildren().addAll(new Faccia2(Constants.SLOT,Constants.SLOT));
        this.getCasella22().getChildren().addAll(new FacciaVuota(Constants.SLOT,Constants.SLOT));
        this.getCasella23().getChildren().addAll(new Faccia1(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella31().getChildren().addAll(new Faccia1(Constants.SLOT,Constants.SLOT));
        this.getCasella32().getChildren().addAll(new Faccia5(Constants.SLOT,Constants.SLOT));
