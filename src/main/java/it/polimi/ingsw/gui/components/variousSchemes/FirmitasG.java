...
public class FirmitasG extends Windows{

    public FirmitasG(){

        super();
        this.setName("Firmitas");

        this.getCasella00().setStyle("-fx-background-color: " + Constants.PURPLE);
        ...
        this.getCasella22().setStyle("-fx-background-color: " + Constants.PURPLE);
        ...
        this.getCasella33().setStyle("-fx-background-color: " + Constants.PURPLE);
        ...
        this.getCasella01().getChildren().addAll(new Faccia6(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella04().getChildren().addAll(new Faccia3(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella12().getChildren().addAll(new Faccia3(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella21().getChildren().addAll(new Faccia2(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella22().getChildren().addAll(new FacciaVuota(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella23().getChildren().addAll(new Faccia1(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella31().getChildren().addAll(new Faccia1(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella32().getChildren().addAll(new Faccia5(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella33().getChildren().addAll(new FacciaVuota(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella34().getChildren().addAll(new Faccia4(Constants.W_SLOT,Constants.H_SLOT));
    }
}
