...
public class FulgordelCieloG extends Windows{
    ...
    public FulgordelCieloG(){
        ...
        this.getCasella11().getChildren().addAll(new Faccia4(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella24().getChildren().addAll(new Faccia5(Constants.SLOT,Constants.SLOT));
        this.getCasella30().getChildren().addAll(new Faccia6(Constants.SLOT,Constants.SLOT));
        this.getCasella31().getChildren().addAll(new FacciaVuota(Constants.SLOT,Constants.SLOT));
        this.getCasella32().getChildren().addAll(new Faccia3(Constants.SLOT,Constants.SLOT));
