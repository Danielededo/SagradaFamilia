...
public class FulgordelCieloG extends Windows{

    public FulgordelCieloG(){

        super();
        this.setName("Fulgor del Cielo");
        ...
        this.getCasella23().setStyle("-fx-background-color: " + Constants.RED);
        ...
        this.getCasella30().getChildren().addAll(new Faccia6(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella31().getChildren().addAll(new FacciaVuota(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella32().getChildren().addAll(new Faccia3(Constants.W_SLOT,Constants.H_SLOT));
