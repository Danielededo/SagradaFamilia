...
public class LuxMundiG extends Windows{
    ...
    public LuxMundiG(){
        ...
        this.getCasella02().getChildren().addAll(new Faccia1(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella10().getChildren().addAll(new Faccia1(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella23().getChildren().addAll(new Faccia6(Constants.W_SLOT,Constants.H_SLOT));
