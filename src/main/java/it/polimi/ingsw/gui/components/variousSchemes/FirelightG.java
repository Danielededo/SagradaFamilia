...
public class FirelightG extends Windows{

    public FirelightG(){

        super();
        this.setName("Firelight");
        ...
        this.getCasella24().setStyle("-fx-background-color: " + Constants.RED);
        ...
        this.getCasella33().setStyle("-fx-background-color: " + Constants.RED);
        this.getCasella34().setStyle("-fx-background-color: " + Constants.WHITE);


        this.getCasella00().getChildren().addAll(new Faccia3(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella34().getChildren().addAll(new Faccia6(Constants.W_SLOT,Constants.H_SLOT));
    }
