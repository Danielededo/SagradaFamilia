...
public class FirelightG extends Windows{
    ...
    public FirelightG(){
        ...
        this.getCasella00().getChildren().addAll(new Faccia3(Constants.SLOT,Constants.SLOT));
        this.getCasella01().getChildren().addAll(new Faccia4(Constants.SLOT,Constants.SLOT));
        this.getCasella02().getChildren().addAll(new Faccia1(Constants.SLOT,Constants.SLOT));
        this.getCasella03().getChildren().addAll(new Faccia5(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella11().getChildren().addAll(new Faccia6(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella30().getChildren().addAll(new Faccia5(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella34().getChildren().addAll(new Faccia6(Constants.SLOT,Constants.SLOT));*/
    }
