...
public class FractalDropsG extends Windows{
    ...
    public FractalDropsG(){
        ...
        this.getCasella04().getChildren().addAll(new Faccia6(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella24().getChildren().addAll(new Faccia1(Constants.SLOT,Constants.SLOT));
