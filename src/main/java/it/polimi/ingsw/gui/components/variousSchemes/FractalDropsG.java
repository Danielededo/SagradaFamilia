...
public class FractalDropsG extends Windows{

    public FractalDropsG(){

        super();
        this.setName("Fractal Drops");
        ...
        this.getCasella03().setStyle("-fx-background-color: " + Constants.YELLOW);
        this.getCasella04().setStyle("-fx-background-color: " + Constants.WHITE);
        this.getCasella10().setStyle("-fx-background-color: " + Constants.RED);
        ...
        this.getCasella22().setStyle("-fx-background-color: " + Constants.RED);
        ...
        this.getCasella01().getChildren().addAll(new Faccia4(Constants.W_SLOT,Constants.H_SLOT));
