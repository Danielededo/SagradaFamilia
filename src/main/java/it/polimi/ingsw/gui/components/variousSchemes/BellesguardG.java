...
public class BellesguardG extends Windows{
    ...
    public BellesguardG(){
        ...
        this.getCasella11().getChildren().addAll(new Faccia3(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella21().getChildren().addAll(new Faccia5(Constants.SLOT,Constants.SLOT));
        this.getCasella22().getChildren().addAll(new Faccia6(Constants.SLOT,Constants.SLOT));
        this.getCasella23().getChildren().addAll(new Faccia2(Constants.SLOT,Constants.SLOT));
