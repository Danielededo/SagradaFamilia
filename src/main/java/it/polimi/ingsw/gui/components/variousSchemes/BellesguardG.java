...
public class BellesguardG extends Windows{
    ...
    public BellesguardG(){
        ...
        this.getCasella34().setStyle("-fx-background-color: " + Constants.GREEN);
        ...
        this.getCasella11().getChildren().addAll(new Faccia3(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella21().getChildren().addAll(new Faccia5(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella22().getChildren().addAll(new Faccia6(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella23().getChildren().addAll(new Faccia2(Constants.W_SLOT,Constants.H_SLOT));
