...
public class SunGloryG extends Windows{
    ...
    public SunGloryG(){
        ...
        this.getCasella23().getChildren().addAll(new Faccia5(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella24().getChildren().addAll(new Faccia3(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella30().getChildren().addAll(new FacciaVuota(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella31().getChildren().addAll(new Faccia5(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella32().getChildren().addAll(new Faccia4(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella33().getChildren().addAll(new Faccia2(Constants.W_SLOT,Constants.H_SLOT));
        this.getCasella34().getChildren().addAll(new Faccia1(Constants.W_SLOT,Constants.H_SLOT));
    }
}
