...
public class SunGloryG extends Windows{
    ...
    public SunGloryG(){
        ...
        this.getCasella14().getChildren().addAll(new Faccia6(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella24().getChildren().addAll(new Faccia3(Constants.SLOT,Constants.SLOT));
