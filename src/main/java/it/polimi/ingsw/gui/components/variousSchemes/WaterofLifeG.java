...
public class WaterofLifeG extends Windows{
    ...
    public WaterofLifeG(){
        ...
        this.getCasella00().getChildren().addAll(new Faccia6(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella20().getChildren().addAll(new Faccia4(Constants.SLOT,Constants.SLOT));
        this.getCasella21().getChildren().addAll(new FacciaVuota(Constants.SLOT,Constants.SLOT));
        this.getCasella22().getChildren().addAll(new Faccia2(Constants.SLOT,Constants.SLOT));
