...
public class ViaLuxG extends Windows{
    ...
    public ViaLuxG(){
        ...
        this.getCasella11().getChildren().addAll(new Faccia1(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella14().getChildren().addAll(new Faccia2(Constants.SLOT,Constants.SLOT));
