...
public class ViaLuxG extends Windows{

    public ViaLuxG(){

        super();
        this.setName("Via Lux");
        ...
        this.getCasella21().setStyle("-fx-background-color: " + Constants.YELLOW);
        ...
        this.getCasella11().getChildren().addAll(new Faccia1(Constants.W_SLOT,Constants.H_SLOT));
