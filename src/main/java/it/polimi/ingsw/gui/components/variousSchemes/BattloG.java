...
public class BattloG extends Windows{
    ...
    public BattloG(){
        ...
        this.getCasella02().getChildren().addAll(new Faccia6(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella11().getChildren().addAll(new Faccia5(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella24().getChildren().addAll(new Faccia2(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella34().getChildren().addAll(new Faccia3(Constants.SLOT,Constants.SLOT));
    }
}
