...
public class AuroraSagradisG extends Windows{
    ...
    public AuroraSagradisG(){
        ...
        this.getCasella10().getChildren().addAll(new Faccia4(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella21().getChildren().addAll(new Faccia1(Constants.W_SLOT,Constants.H_SLOT));
