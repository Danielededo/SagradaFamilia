...
public class AuroraSagradisG extends Windows{
    ...
    public AuroraSagradisG(){
        ...
        this.getCasella10().getChildren().addAll(new Faccia4(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella21().getChildren().addAll(new Faccia1(Constants.SLOT,Constants.SLOT));
        this.getCasella22().getChildren().addAll(new FacciaVuota(Constants.SLOT,Constants.SLOT));
        this.getCasella23().getChildren().addAll(new Faccia5(Constants.SLOT,Constants.SLOT));
