...
public class AuroraeMagnificusG extends Windows {
    ...
    public AuroraeMagnificusG(){
        ...
        this.getCasella00().getChildren().addAll(new Faccia5(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella04().getChildren().addAll(new Faccia2(Constants.W_SLOT,Constants.H_SLOT));
        ...
        this.getCasella22().getChildren().addAll(new Faccia6(Constants.W_SLOT,Constants.H_SLOT));
