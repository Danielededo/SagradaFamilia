...
public class AuroraeMagnificusG extends Windows {
    ...
    public AuroraeMagnificusG(){
        ...
        this.getCasella00().getChildren().addAll(new Faccia5(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella04().getChildren().addAll(new Faccia2(Constants.SLOT,Constants.SLOT));
        ...
        this.getCasella22().getChildren().addAll(new Faccia6(Constants.SLOT,Constants.SLOT));
